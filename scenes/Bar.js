export default class Bar extends Phaser.Scene
{
    ...
    preload()
    {
        this.load.spritesheet('bar_wall', '../../assets/sprites/Scenario/Objects/Hospital Environment Mini Asset - Expansion Pack 1/tilemap/bar_walls.png', { frameWidth: 20, frameHeight: 34})
